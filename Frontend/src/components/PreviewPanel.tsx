            ...
            {isLoading && (
                <div className='absolute inset-0 flex flex-col items-center justify-center gap-2 bg-black/25'>
                    ...
                    <div className='text-center'>
                        <p className='mt-1 font-medium text-zinc-400'>AI is creating your thumbnail....</p>
            ...
            {!isLoading && !thumbnail?.image_url && (
                <div className='absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25'>
                    ...
                    <div className='px-4 text-center'>
                        ...
                        <p className='mt-1 text-xs text-zinc-400'>Fill out the form above to generate your first thumbnail</p>
                    </div>
                </div>
            )}
        </div>
